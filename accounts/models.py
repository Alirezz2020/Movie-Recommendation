...
class Profile(models.Model):
    ...
    watched_movies = models.ManyToManyField('movies.Movie', related_name='watched_by', blank=True)
    saved_movies = models.ManyToManyField('movies.Movie', related_name='saved_by', blank=True)
    preferences = models.JSONField(default=dict, blank=True)  # Stores genre preferences, etc.
